using DGML_Generator;
using System.Collections.Generic;
using System.Xml;
using System.Xml.Serialization;
using static DGML_Generator.Style;
...
namespace DGML
{
    ...
    {   
        ...
        public DgmlWriter(bool addDefaultStyles) : this()
        {
            if (addDefaultStyles)
            {
        ...
        {
            Nodes.Add(new Node(id, label, group: "Expanded", category: "CodeSchema_Assembly"));
        }
        /// <summary>
        ...
        {
            Nodes.Add(new Node(id, label, group: "Expanded", category: "CodeSchema_Namespace"));
        }
        /// <summary>
        ...
        {
            Nodes.Add(new Node(id, label, group: "Expanded", category: "CodeSchema_Class"));
        }
        /// <summary>
        ...
        {
            Nodes.Add(new Node(id, label, group: "Expanded", category: "CodeSchema_Interface"));
        }
        /// <summary>
        ...
        {
            Nodes.Add(new Node(id, label, group: "Expanded", category: "CodeSchema_Enum"));
        }
        /// <summary>
        ...
        {
            Nodes.Add(new Node(id, label, category: "CodeSchema_Method"));
        }
        /// <summary>
        ...
        {
            Nodes.Add(new Node(id, label, category: "CodeSchema_Field"));
        }
        /// <summary>
        ...
        public void SetLinked(string fromId, string toId, LinkStyle style = LinkStyle.Solid)
        {
            switch(style)
            {
                case LinkStyle.Solid:

                    break;
                case LinkStyle.Dashed:

                    break;
                case LinkStyle.Hidden:

                    break;
            }
            // TODO change link styles
